...
** Upcoming:
-	Selectable page segmentation modes
-	Scaling of processed subtitles
...
* NOTE: This PPA is no longer maintained and it is recommended to build from 
	current source.
...
For bug reports please run =vobsub2srt= with the =--verbose= option set to 3,
and copy and paste the full output to the bug report.

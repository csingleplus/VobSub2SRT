...
** July 2026
-		Rewrite incoming. Give me a couple weeks to a month. Results are promising
		with increased speed and accuracy.

** Jun 2026
-       PNG export added, cast vobsubid to avoid left shift.
-       Image inversion added. Code by Ethan Dye, used with
        permission  (https://github.com/ecdye/VobSub2SRT)

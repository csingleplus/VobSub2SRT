...
Issues may be brought up here: [[https://github.com/BuiltOnLogic/VobSub2SRT/issues]],
but please note this is a work in progress and subject to change.

If you have problems with a specific subtitle file then please check if
it works in mplayer or mpv first.  If it does not then please report the bug to
mplayer/mpv as well and link to the bug report.

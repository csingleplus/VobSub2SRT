...
Replacements file, see [[https://github.com/wififreedom/VobSub2SRT/replacement/replacements_EN.txt][example]]:
...
#+BEGIN_EXAMPLE
vobsub2srt --replacements replacements_EN.txt --detect-italic --base-duration 1500 --chars-per-sec 19 --tesseract-lang 'eng+fra' my-movie-subtitle
#+END_EXAMPLE
